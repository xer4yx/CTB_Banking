...
public class HelpAndResources {
    ...
    protected static void saveHelpAndResources(final String username, final String h_rType,
        ...
        for (User user : BankSystem.users)
        {
            ...
            {
                HelpAndResources helpandresources = new HelpAndResources();
                helpandresources.setHelpID(generateHelpID(h_rType));
                helpandresources.setH_rType(h_rType);
                helpandresources.setH_rDescription(h_rDescription);
